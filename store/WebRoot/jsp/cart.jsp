...
<html>
	...
	<body>
							...
							<tbody>
								...
								<c:forEach items="${cart.items }" var="i">
									<tr class="active">
										...
										<td width="10%">
											<input type="text" name="quantity" value="${i.count}" maxlength="4" size="10" readonly="readonly">
										</td>
										<td width="15%">
											<span class="subtotal">￥${i.subtotal }</span>
										</td>
										<td>
											<a href="javascript:void(0)" onclick="removeFromCart(${i.product.pid})" class="delete">删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
		...
		<div style="margin-top:50px;">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/footer.jpg" width="100%" height="78" alt="我们的优势" title="我们的优势" />
		</div>
