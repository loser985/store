...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/adminProduct?method=findAll&flag=0&currPage=1','','mainFrame');
		d.add('010402','0104','已下架商品','${pageContext.request.contextPath}/adminProduct?method=findAll&flag=1&currPage=1','','mainFrame');
		d.add('0105','01','订单管理');
