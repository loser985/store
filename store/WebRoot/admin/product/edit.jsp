	...
	<body>
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct?method=edit" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商品图片：<img alt="${p.pname }" height="100px" width="80px" name="pimage" src="${pageContext.request.contextPath }/${p.pimage}">
					</td>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="cid">
								<c:forEach items="${c}" var="i">
									<c:if test="${cid == i.cid }">
										<option  value="${i.cid }" selected="selected">${i.cname }</option>
									</c:if>
									<c:if test="${cid != i.cid }">
