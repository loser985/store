	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			...
			<div class="col-md-10 col-sm-12">
				<div class="hidden-xs col-md-6 col-sm-12"
				...
				<c:forEach items="${nlist }" var="i">
					<div class="col-md-2  col-sm-4	col-xs-6"
						...
						<a href="${pageContext.request.contextPath}/product?method=getById&pid=${i.pid}"> <img
							src="${pageContext.request.contextPath}/${i.pimage}" width="130"
							height="130" style="display: inline-block;">
						</a>
						<p>
							<a href="${pageContext.request.contextPath}/product?method=getById&pid=${i.pid}" style='color:#666'>${fn:substring(i.pname,0,10)}...</a>
						</p>
						<p>
