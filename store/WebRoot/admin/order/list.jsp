		...
		<script type="text/javascript">
				function showDetail(oid){
					$.post("${pageContext.request.contextPath}/adminOrder",{"method":"getDetailByOid","oid":oid},function(data){
						var s="<table class='table table-striped'><tr><th>商品名称</th><th>购买数量</th><th>单价</th><th>小计</th></tr>";
						$(data).each(function(){
							s+=("<tr><td>"+this.product.pname+"</td><td>"+this.count+"</td><td>"+this.product.shop_price+"</td><td>"+this.subtotal+"</td></tr>");
						});
						s+="</table>";
									...
									<c:forEach items="${list }" var="o" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==1 }">已付款&nbsp;|&nbsp;<a href='${pageContext.request.contextPath }/adminOrder?method=updateState&oid=${o.oid}&state=2' class="btn btn-default">发货</a></c:if>
